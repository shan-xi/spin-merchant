...
//        treeMap.put("CVV", "123");
    ...
    private static Map<String, String> getParameterMapForCARD(String payId) {
        ...
        treeMap.put("ORDER_ID", "SPINPI"+currentDateTime.format(formatter));
        treeMap.put("RETURN_URL", "https://localhost:8443/payInCallBack");
        treeMap.put("PAYMENT_TYPE", "CARD"); // UP NB WL CARD
//        treeMap.put("PAYER_ADDRESS", "abc@ybl");
        treeMap.put("MOP_TYPE", "CC"); // 1030
        treeMap.put("CARD_HOLDER_NAME", "spin liao");
        treeMap.put("CARD_NUMBER", "4539148803436467");
        treeMap.put("CARD_EXP_DT", "072025");
        treeMap.put("CVV", "123");
    ...
    private static Map<String, String> getParameterMapForNB(String payId) {
        ...
        treeMap.put("ORDER_ID", "SPINPI"+currentDateTime.format(formatter));
        treeMap.put("RETURN_URL", "https://localhost:8443/payInCallBack");
        treeMap.put("PAYMENT_TYPE", "NB"); // UP NB WL CARD
//        treeMap.put("PAYER_ADDRESS", "abc@ybl");
...
//        treeMap.put("CVV", "123");
    ...
    private static Map<String, String> getParameterMapForWL(String payId) {
        ...
        treeMap.put("ORDER_ID", "SPINPI"+currentDateTime.format(formatter));
        treeMap.put("RETURN_URL", "https://localhost:8443/payInCallBack");
        treeMap.put("PAYMENT_TYPE", "WL"); // UP NB WL CARD
//        treeMap.put("PAYER_ADDRESS", "abc@ybl");
